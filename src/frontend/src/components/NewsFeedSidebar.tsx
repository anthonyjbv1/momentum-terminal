...
const INDEX_SHORT_NAMES: Record<string, string> = {
  ...
  // Sports
  "Kansas City Chiefs Sentiment": "KC CHIEFS",
  "Denver Broncos Sentiment": "BRONCOS",
  "Patrick Mahomes Sentiment": "MAHOMES",
  "FC Barcelona Sentiment": "BARCELONA",
  "Real Madrid CF Sentiment": "REAL MADRID",
  "France National Team Sentiment": "FRANCE",
  "Spain National Team Sentiment": "SPAIN",
  "Ferrari Sentiment": "FERRARI",
  "McLaren Sentiment": "MCLAREN",
  "Mercedes Sentiment": "MERCEDES",
  "F1 Ferrari Sentiment": "FERRARI",
  "F1 McLaren Sentiment": "MCLAREN",
  "F1 Mercedes Sentiment": "MERCEDES",
  // Influencers / creators
  "MrBeast Sentiment": "MRBEAST",
  "Kai Cenat Sentiment": "KAI CENAT",
  "Adin Ross Sentiment": "ADIN ROSS",
  "Drake Sentiment": "DRAKE",
  "Kendrick Lamar Sentiment": "KENDRICK",
  // Forbes billionaires
  "Elon Musk Sentiment": "ELON MUSK",
  "Jeff Bezos Sentiment": "BEZOS",
  "Mark Zuckerberg Sentiment": "ZUCKERBERG",
  "Jensen Huang Sentiment": "JENSEN HUANG",
  "Warren Buffett Sentiment": "BUFFETT",
  "Larry Ellison Sentiment": "ELLISON",
  "Larry Page Sentiment": "LARRY PAGE",
  "Sergey Brin Sentiment": "SERGEY BRIN",
  "Michael Dell Sentiment": "DELL",
  "Bernard Arnault Sentiment": "ARNAULT",
  // Health / pharma
  "Ozempic Sentiment": "OZEMPIC",
  "Wegovy Sentiment": "WEGOVY",
  "Alzheimer's Sentiment": "ALZHEIMER'S",
  "Cancer Research Sentiment": "CANCER",
  "Mental Health Sentiment": "MENTAL HEALTH",
  "Type 2 Diabetes Sentiment": "DIABETES",
  "Seasonal Influenza Sentiment": "FLU",
  "Adderall Sentiment": "ADDERALL",
  "COVID Variant Sentiment": "COVID",
  "Long COVID Sentiment": "LONG COVID",
  // Geo / macro
  "China Sentiment": "CHINA",
  "Germany Sentiment": "GERMANY",
  "United States Sentiment": "US",
  "California Sentiment": "CALIFORNIA",
  "Texas Sentiment": "TEXAS",
  "Florida Sentiment": "FLORIDA",
  "New York Sentiment": "NEW YORK",
  // Universities
  "Harvard University Sentiment": "HARVARD",
  "Yale University Sentiment": "YALE",
  "Ohio State University Sentiment": "OHIO STATE",
  "University of Michigan Sentiment": "MICHIGAN",
};
...
const SOURCE_LABEL_MAP: Record<string, string> = {
  ...
  nbschina: "NBS CHINA",
  "apisports-soccer": "API-SPORTS",
  "apisports-nfl": "API-SPORTS",
  "apisports-f1": "API-SPORTS",
  fotmob: "FOTMOB",
  scorecard: "SCORECARD",
  congress: "CONGRESS",
