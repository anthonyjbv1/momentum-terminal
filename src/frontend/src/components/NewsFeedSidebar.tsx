...
const INDEX_SHORT_NAMES: Record<string, string> = {
  ...
  "Traditional Values Sentiment": "TRAD VALUES",
  "Progressive Values Sentiment": "PROG VALUES",
  "Masculinity Discourse Sentiment": "MASCULINITY",
  "Feminism Wave Sentiment": "FEMINISM WAVE",
  "F1 Constructor Sentiment": "F1 CONSTRUCTOR",
  "NASCAR Racing Sentiment": "NASCAR",
...
const INDEX_CATEGORY_MAP: Record<string, FeedCategoryFilter> = {
  ...
  "Traditional Values Sentiment": "cultural",
  "Progressive Values Sentiment": "cultural",
  "Masculinity Discourse Sentiment": "cultural",
  "Feminism Wave Sentiment": "cultural",
  "F1 Constructor Sentiment": "sports",
  "NASCAR Racing Sentiment": "sports",
