...
export const INDEX_NAMES = {
  ...
  TRAD: "Traditionalism Sentiment",
  PROG: "Progressivism Sentiment",
  MASC: "Masculism Sentiment",
  FEM: "Feminism Sentiment",
  F1: "F1 Constructor Sentiment",
  NASCAR: "NASCAR Sentiment",
